	...
	<div id="supNav">
		<ul>
			...
			//Sinon si vous etes connecté
				...
				echo "<li><a href=\"./index.php?controller=client&action=read&id=" . $_SESSION['id'] . "\">Mon compte</a> / <a href=\"./index.php?controller=client&action=deconnected\">Déconnexion</a></li>";
			}
			?>
		</ul>
	</div>
